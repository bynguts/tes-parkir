 ...
 * Premium design for Cereza SmartParking
 */
...
<head>
    ...
    <title>SmartParking — Secure & Seamless Parking</title>
...
<body class="dark bg-page">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 glass-nav">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xl font-manrope font-800 tracking-tight">Smart<span class="text-brand">Parking</span></span>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-surface p-8 rounded-3xl border border-color hover:border-brand transition-all group">
                    ...
                    <p class="text-secondary text-sm leading-relaxed">Access parking across multiple malls and commercial hubs with a single SmartParking account.</p>
                </div>
    ...
    <footer class="py-12 border-t border-white/5">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <p class="text-slate-500 text-sm">&copy; 2026 SmartParking. Built for perfection.</p>
