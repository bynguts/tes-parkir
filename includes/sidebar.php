...
?>
<!-- SIDEBAR -->
<aside class="fixed top-0 left-0 h-screen flex flex-col z-40 sidebar-main">

    <!-- Brand -->
    <div class="px-6 h-20 flex items-center justify-between gap-3 sidebar-brand-box">
        <div class="flex items-center gap-3">
            <div class="w-8 h-8 rounded-lg flex items-center justify-center sidebar-brand-icon overflow-hidden">
                <img src="<?= BASE_URL ?>assets/img/logo_p.png" alt="Logo" class="w-full h-full object-contain">
            </div>
            <div class="sidebar-brand-text">
                <span class="font-inter text-base leading-tight sidebar-brand-text-main font-black">Smart</span><span class="font-inter text-base leading-tight sidebar-brand-text-sub font-black">Parking</span>
            </div>
        </div>
    </div>
