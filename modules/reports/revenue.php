        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-slate-900 rounded-2xl p-6 ring-1 ring-white/10 shadow-[0_30px_60px_-12px_rgba(15,23,42,0.3)]">
                <div class="flex items-center justify-between mb-5 -mt-2">
                    <p class="text-[10px] font-bold uppercase tracking-widest text-slate-900/40 font-inter">Total Trx</p>
                    <div class="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center border border-white/10">
                        <i class="fa-solid fa-receipt text-slate-900/40 text-lg"></i>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-2xl p-6 ring-1 ring-slate-900/5 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
                <div class="flex items-center justify-between mb-5 -mt-2">
                    <p class="text-[11px] font-extrabold uppercase tracking-[0.2em] text-slate-900/40 font-inter">Cars Exited</p>
            ...
            <div class="bg-white rounded-2xl p-6 ring-1 ring-slate-900/5 shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
                <div class="flex items-center justify-between mb-5 -mt-2">
                    <p class="text-[11px] font-extrabold uppercase tracking-[0.2em] text-slate-900/40 font-inter">Motorcycles Exited</p>
                ...
                <div class="font-manrope font-extrabold text-4xl text-slate-900 mb-1"><?= number_format($totals['total_motorcycles'] ?? 0) ?></div>
                <p class="text-slate-900/40 text-[11px] uppercase font-extrabold tracking-[0.2em] font-inter mt-3"><?= fmt_idr((float)($totals['rev_motorcycle'] ?? 0)) ?></p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-6 ring-1 ring-slate-900/5 shadow-[0_8px_30px_rgba(15,23,42,0.04)] border-l-4 border-amber-400">
                <div class="flex items-center justify-between mb-5 -mt-2">
                    <p class="text-[11px] font-extrabold uppercase tracking-[0.2em] text-slate-900/40 font-inter">Total Net Revenue</p>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-slate-900/[0.03]">
                        ...
                        <tr class="hover:bg-slate-900/[0.02] transition-colors">
                            ...
                            <td class="px-4 py-4 text-center">
                                <span class="bg-emerald-50/10 text-emerald-700 border border-emerald-500/10 text-[10px] font-bold font-inter uppercase tracking-widest px-3 py-1 rounded-lg"><?= $row['motorcycles'] ?></span>
                            </td>
                            ...
                            <td class="px-4 py-4 text-right text-slate-900/40 text-sm font-inter"><?= fmt_idr((float)$row['revenue_motorcycle']) ?></td>
                    ...
                    <tfoot class="bg-slate-900/[0.03]">
                        <tr class="border-t-2 border-slate-900/10">
                            ...
                            <td class="px-4 py-4 text-right font-inter font-bold text-slate-900"><?= fmt_idr((float)($totals['rev_motorcycle'] ?? 0)) ?></td>
